...
export function Sidebar() {
    ...
    return (
        <aside className="flex flex-col h-full w-64 border-r border-border bg-card/50">
            ...
            <div className="p-3">
                <Button
                    className="w-full gap-2 bg-primary/10 hover:bg-primary/20 text-primary border border-primary/20 hover:border-primary/40 transition-all"
                    variant="ghost"
            ...
            <div className="px-3 pb-2">
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="pl-8 h-8 text-sm bg-accent/50 border-border focus-visible:ring-primary/30"
                    />
                </div>
            </div>
